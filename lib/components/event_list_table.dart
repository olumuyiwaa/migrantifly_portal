...
class EventListTable extends StatefulWidget {
  ...
  @override
  State<EventListTable> createState() => _EventListTableState();
}

class _EventListTableState extends State<EventListTable> {
  int _currentPage = 1;
  ...
  @override
  void didUpdateWidget(EventListTable oldWidget) {
  ...
  List<Application> get _filteredApplications {
    ...
    return applications.where((app) {
      return widget.filter.contains(app.visaType);
    }).toList();
  }
